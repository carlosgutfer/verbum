...
public abstract class PalabrasRoomDataBase extends RoomDatabase {
    ...
    private static void addItemspalfra(PalfraDao dao2) {
        ...
        dao2.insert(new palfraEntity(81,316,1));
        dao2.insert(new palfraEntity(81,629,2));
        dao2.insert(new palfraEntity(81,485,3));
        dao2.insert(new palfraEntity(81,436,4));
        dao2.insert(new palfraEntity(81,630,5));

        dao2.insert(new palfraEntity(80,445,1));
        dao2.insert(new palfraEntity(80,626,2));
        dao2.insert(new palfraEntity(80,323,3));
        dao2.insert(new palfraEntity(80,627,4));
        dao2.insert(new palfraEntity(80,308,5));
        dao2.insert(new palfraEntity(80,628,6));

        dao2.insert(new palfraEntity(79,445,1));
        dao2.insert(new palfraEntity(79,624,2));
        dao2.insert(new palfraEntity(79,625,3));
        dao2.insert(new palfraEntity(79,305,4));
        dao2.insert(new palfraEntity(79,69,5));
        dao2.insert(new palfraEntity(79,460,6));

        dao2.insert(new palfraEntity(78,316,1));
        dao2.insert(new palfraEntity(78,622,2));
        dao2.insert(new palfraEntity(78,238,3));
        dao2.insert(new palfraEntity(78,385,4));
        dao2.insert(new palfraEntity(78,236,5));
        dao2.insert(new palfraEntity(78,337,6));
        dao2.insert(new palfraEntity(78,623,7));
